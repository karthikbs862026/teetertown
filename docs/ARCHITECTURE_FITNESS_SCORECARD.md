...
| Same replay is deterministic                             | Identical periodic/final hashes across repeated runs           | Golden hashes match through 278                | Headless pass                |
...
| Level unload returns resource baseline                   | No monotonic registry growth after 50 post-warm-up cycles      | Simulation topology `11/11/2` ×50              | Simulation pass; GPU pending |
